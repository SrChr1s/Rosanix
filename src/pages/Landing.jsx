...
export default function Landing() {
  return (
    <Layout className="min-h-screen bg-[url('/background.png')] flex flex-col">
      ...
      <Content className="flex-grow flex justify-center items-center py-6 px-4 overflow-y-auto">
        <div className="flex flex-col w-full max-w-xs sm:max-w-md lg:max-w-xl p-6 sm:p-10 md:p-12 bg-white/25 rounded-3xl text-center">
          <h1 className="text-[#456297] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-[Bebas] mt-4 sm:mt-8 mb-4 break-words leading-snug">
